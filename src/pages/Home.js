...
import uconn from "../images/uconn_logo.jpg";
import zap from "../images/zap_logo.jpeg";
  ...
  <Container>
    ...
    <ImageCombination>
      <a href = "https://seniordesign.engr.uconn.edu/" rel = "noreferrer" target = "_blank">
          <img src = {uconn} alt = "uconn" width = "600" height = "180"></img>
      </a>
      <p>x</p>
      <a href = "https://zap.org/home" rel = "noreferrer" target = "_blank">
        <img src = {zap} alt = "zap" width = "600" height = "300"></img>
      </a>
    </ImageCombination>
